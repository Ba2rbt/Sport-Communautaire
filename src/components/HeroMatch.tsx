...
import { PrimaryButton, TeamLogo } from './ui'
  ...
  return (
    <section className="relative w-full overflow-hidden text-white min-h-[85vh] flex items-center justify-center">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-0 right-1/4 w-96 h-96 bg-accent/10 rounded-full blur-[128px] animate-pulse-slow"
            ...
            <div className="flex flex-col items-center justify-center">
              {match.status === 'upcoming' ? (
                <div className="text-center p-8 rounded-3xl glass border-white/5 bg-white/[0.02]">
                  ...
                  <div className="text-slate-400 font-medium tracking-widest uppercase">
                    {match.date}
                  </div>
                </div>
              ) : (
